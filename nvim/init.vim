...
set runtimepath+=~/.local/share/nvim/bundle/repos/github.com/Shougo/dein.vim

if dein#load_state('~/.local/share/nvim/bundle')
  call dein#begin('~/.local/share/nvim/bundle')
